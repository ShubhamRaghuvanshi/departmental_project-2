...
\newpage
 	\begin{figure}[h]
 		\begin{centering}	
 			...
 			\caption{Scatter plot between angular separation between decaying particles of the top and w decay, in $(y,\phi)$ plane, and $p_T$ of top and w respectively.}
 			\label{rwbt}
 			\centering
 		\end{centering} 		
 	\end{figure}   
