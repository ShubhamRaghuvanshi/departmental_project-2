...
\begin{figure}[h]
	\begin{centering}	
		\includegraphics[scale=0.15]{../pp2zp2tt2qqblv_2000root/jets/top(kin)_M_stack.png} 
		\includegraphics[scale=0.15]{../pp2zp2tt2qqblv_2000root/jets/top(kin)_pT_stack.png}
        \includegraphics[scale=0.15]{../pp2zp2tt2qqblv_2000root/jets/top(chi)_M_stack.png} 
		\includegraphics[scale=0.15]{../pp2zp2tt2qqblv_2000root/jets/top(chi)_pT_stack.png}
